...
// .wrangler/tmp/pages-U9AshN/functionsWorker-0.8025687612975045.mjs
  ...
  "groups": [
    ...
    },
    {
      ...
      "members": [
        ...
        { "name": "Ros\xE9", "position": ["Main Vocalist", "Lead Dancer"] },
...
function generateAnalysisResult(answers) {
  let leaderScore = 0;
  let vocalScore = 0;
  let danceScore = 0;
  let rapScore = 0;
  ...
  if (scores.leaderScore === maxScore) {
    positionType = "Leader";
    const leaderMembers = [
      { member: kpopGroupsData.groups[0].members[0], group: "BTS" },
      // RM
      { member: kpopGroupsData.groups[2].members[0], group: "IVE" },
      // Yujin
      { member: kpopGroupsData.groups[3].members[0], group: "aespa" },
      // Karina
      { member: kpopGroupsData.groups[4].members[0], group: "(G)I-DLE" }
      // Soyeon
    ];
    ...
    const vocalMembers = [
      { member: kpopGroupsData.groups[0].members[6], group: "BTS" },
      // Jungkook
      { member: kpopGroupsData.groups[1].members[2], group: "BLACKPINK" },
      // Rosé
      { member: kpopGroupsData.groups[2].members[4], group: "IVE" },
      // Liz
      { member: kpopGroupsData.groups[3].members[3], group: "aespa" },
      // Ningning
      { member: kpopGroupsData.groups[4].members[1], group: "(G)I-DLE" }
      // Minnie
    ];
    ...
    const danceMembers = [
      { member: kpopGroupsData.groups[0].members[3], group: "BTS" },
      // j-hope
      { member: kpopGroupsData.groups[0].members[4], group: "BTS" },
      // Jimin
      { member: kpopGroupsData.groups[1].members[3], group: "BLACKPINK" },
      // Lisa
      { member: kpopGroupsData.groups[3].members[0], group: "aespa" }
      // Karina
    ];
    ...
    const rapMembers = [
      { member: kpopGroupsData.groups[0].members[0], group: "BTS" },
      // RM
      { member: kpopGroupsData.groups[1].members[1], group: "BLACKPINK" },
      // Jennie
      { member: kpopGroupsData.groups[2].members[1], group: "IVE" },
      // Gaeul
      { member: kpopGroupsData.groups[3].members[1], group: "aespa" },
      // Giselle
      { member: kpopGroupsData.groups[4].members[0], group: "(G)I-DLE" }
      // Soyeon
    ];
    ...
    positionType = "Visual";
    const visualMembers = [
      { member: kpopGroupsData.groups[0].members[1], group: "BTS" },
      // Jin
      { member: kpopGroupsData.groups[0].members[5], group: "BTS" },
      // V
      { member: kpopGroupsData.groups[1].members[0], group: "BLACKPINK" },
      // Jisoo
      { member: kpopGroupsData.groups[2].members[3], group: "IVE" },
      // Wonyoung
      { member: kpopGroupsData.groups[3].members[2], group: "aespa" },
      // Winter
      { member: kpopGroupsData.groups[4].members[3], group: "(G)I-DLE" }
      // Shuhua
    ];
...
__name2(generateAnalysisResult, "generateAnalysisResult");
...
// .wrangler/tmp/bundle-gNJFMj/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-gNJFMj/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8025687612975045.js.map
